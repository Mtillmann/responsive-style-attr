describe("Key To Media Query Expansion", function () {
    const xs = '0',
        ...
        keysToExpand = [
            ['xs', `@media all and (min-width: ${xs}) and (max-width: ${sm})`],
            ['sm', `@media all and (min-width: ${sm}) and (max-width: ${md})`],
            ['md', `@media all and (min-width: ${md}) and (max-width: ${lg})`],
            ['lg', `@media all and (min-width: ${lg}) and (max-width: ${xl})`],
            ['xl', `@media all and (min-width: ${xl}) and (max-width: ${xxl})`],
            ['xxl', `@media all and (min-width: ${xxl})`],
            ['md@portrait', `@media all and (min-width: ${md}) and (max-width: ${lg}) and (orientation: portrait)`],
            ['md@ portrait ', `@media all and (min-width: ${md}) and (max-width: ${lg}) and (orientation: portrait)`],
            ['md@landscape', `@media all and (min-width: ${md}) and (max-width: ${lg}) and (orientation: landscape)`],
            ['md@  landscape    ', `@media all and (min-width: ${md}) and (max-width: ${lg}) and (orientation: landscape)`],
            ['md ', `@media all and (min-width: ${md}) and (max-width: ${lg})`],
            ['     md', `@media all and (min-width: ${md}) and (max-width: ${lg})`],
            ['     @md@', `@media all and (min-width: ${md}) and (max-width: ${lg})`],
            ['   @@@@md@md ', `@media all and (min-width: ${md}) and (max-width: ${lg})`],
            ['   @@md@  @ landscape ', `@media all and (min-width: ${md}) and (max-width: ${lg}) and (orientation: landscape)`],
            ['screen   @@md@  @ landscape ', `@media screen and (min-width: ${md}) and (max-width: ${lg}) and (orientation: landscape)`],
            ['screen@md', `@media screen and (min-width: ${md}) and (max-width: ${lg})`],
            ['screen@md@portrait', `@media screen and (min-width: ${md}) and (max-width: ${lg}) and (orientation: portrait)`],
            ['xs-to-sm', `@media all and (min-width: ${xs}) and (max-width: ${sm})`],
            ['sm-to-md', `@media all and (min-width: ${sm}) and (max-width: ${md})`],
            ['md-to-lg', `@media all and (min-width: ${md}) and (max-width: ${lg})`],
            ['lg-to-xl', `@media all and (min-width: ${lg}) and (max-width: ${xl})`],
            ['xl-to-xxl', `@media all and (min-width: ${xl}) and (max-width: ${xxl})`],
            ['xxl-to-GARBLED', '@media all'],
            ['xs-to-md', `@media all and (min-width: ${xs}) and (max-width: ${md})`],
            ['sm-to-xl', `@media all and (min-width: ${sm}) and (max-width: ${xl})`],
            ['md-to-xxl', `@media all and (min-width: ${md}) and (max-width: ${xxl})`],
            ['xs-down', `@media all and (max-width: ${xs})`],
            ['sm-down', `@media all and (max-width: ${sm})`],
            ['md-down', `@media all and (max-width: ${md})`],
            ['lg-down', `@media all and (max-width: ${lg})`],
            ['xl-down', `@media all and (max-width: ${xl})`],
            ['xxl-down', `@media all and (max-width: ${xxl})`],
            ...
            ['1000px-down', '@media all and (max-width: 1000px)'],
            ['500px-to-666px', '@media all and (min-width: 500px) and (max-width: 666px)'],
            ['600px-to-800px', '@media all and (min-width: 600px) and (max-width: 800px)'],
            ['lg-to-1680px', `@media all and (min-width: ${lg}) and (max-width: 1680px)`],
            ['255px-to-500px@portrait', '@media all and (min-width: 255px) and (max-width: 500px) and (orientation: portrait)'],
            ['255px-to-lg', `@media all and (min-width: 255px) and (max-width: ${lg})`],
            ...
            ['@xs', '@media all and (min-width: 0) and (max-width: 576px)'],
            ['@print,screen@xs', '@media print,screen and (min-width: 0) and (max-width: 576px)'],
